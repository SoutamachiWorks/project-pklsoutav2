      ...
      <section className="bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-600 text-white py-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <div className="inline-block px-4 py-2 bg-white/20 backdrop-blur-sm rounded-full text-sm font-semibold mb-4">
            Program Pembinaan & Pemberdayaan
          </div>
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4">Program Kami</h1>
          <p className="text-lg md:text-xl opacity-90 max-w-3xl mx-auto leading-relaxed">
            Berbagai program unggulan, beasiswa, dan pelatihan untuk mengembangkan 
            pemuda berprestasi dan atlet juara Sumatera Barat
          </p>
        </div>
      </section>
