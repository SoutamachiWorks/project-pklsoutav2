...
// ======= FEATHER ICONS (All non-social media icons) =======
...
// News/File Text Icon (Feather)
export const NewsIcon = ({ className = "w-5 h-5" }: { className?: string }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2">
...
// Activity/Sport Icon (Feather)
export const SportIcon = ({ className = "w-5 h-5" }: { className?: string }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2">
    <polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/>
  </svg>
);

// Award/Medal Icon (Feather)
...
// Building/Stadium Icon (Feather)
export const StadiumIcon = ({ className = "w-5 h-5" }: { className?: string }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2">
...
// Program/Clipboard Icon (Feather)
export const ProgramIcon = ({ className = "w-5 h-5" }: { className?: string }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2">
...
// Gallery/Image Icon (Feather)
export const GalleryIcon = ({ className = "w-5 h-5" }: { className?: string }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2">
...
// Contact/User Icon (Feather)
export const ContactIcon = ({ className = "w-5 h-5" }: { className?: string }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2">
...
// Megaphone/Speaker Icon (Feather)
export const MegaphoneIcon = ({ className = "w-5 h-5" }: { className?: string }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2">
    <path d="M3 11v8a2 2 0 0 0 2 2h2v-4h2l4 4V7l-4 4H7V7a2 2 0 0 0-2-2H3"/>
...
// Monitor Icon (Feather)
export const MonitorIcon = ({ className = "w-5 h-5" }: { className?: string }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2">
...
// ======= SOCIAL MEDIA ICONS (Keep existing) =======
